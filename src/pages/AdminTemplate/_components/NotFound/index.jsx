...
export default function NotFound({
    ...
    return (
        <div className="relative z-20 flex w-full items-center justify-center bg-transparent px-8 py-12">
            <div className="mx-auto w-full max-w-2xl rounded-xl border border-slate-200 bg-white px-6 py-10 text-center shadow-sm dark:border-zinc-700/80 dark:bg-zinc-900/50 dark:shadow-none">
